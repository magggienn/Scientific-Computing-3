...
Description: Implementation of the MembraneSolver class that solves the
eigenvalue problem for a vibrating membrane. The class can handle square,
rectangular, and circular membranes. The eigenvalue problem is solved using
dense or sparse matrices.

The code also provides functions to animate the strings motion and plot time
snapshots of the string at various time steps.
'''
import numpy as np
